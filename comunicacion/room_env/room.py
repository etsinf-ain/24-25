   ...
   # los métodos de lock/unlock actualizan las creencias de los agentes 
    def lock(self):
        ...
        for ag in self.seenby:
            ag.bdi.remove_belief("door","unlocked")
            ag.bdi.set_belief("door", "locked")

    def unlock(self):
        print("[door] update beliefs (unlock)")
        for ag in self.seenby:
            ag.bdi.remove_belief("door","locked")
            ag.bdi.set_belief("door","unlocked")           
